...
description: "Starting from scratch, create an Azure API Management instance, configure endpoints, set up rate-limiting, transform data, provide a developer portal, and add security and performance."
type: "session"
durations: [60, 75]
level: "intermediate"
tags:
...
resources:
  - type: "github"
    title: "FileNew-APIManagement Repository"
...
### Target Audience
- Developers building and exposing APIs
- Architects designing API-first systems
- Teams needing to manage, secure, and document their APIs in Azure

### Prerequisites
- Basic understanding of REST APIs and HTTP
- Familiarity with Azure services
- Some experience with .NET or C# development
