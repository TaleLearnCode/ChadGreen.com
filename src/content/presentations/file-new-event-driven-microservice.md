...
description: "Starting with an empty Visual Studio solution, build an event-driven microservice architecture to solve a real-world problem from the ground up."
type: "session"
durations: [45, 60, 75]
level: "intermediate"
tags:
...
resources:
  - type: "github"
    title: "FileNew-EventDrivenArchitectedMicroservice Repository"
    url: "https://github.com/TaleLearnCode/FileNew-EventDrivenArchitectedMicroservice"
...
- Basic programming knowledge in C#, Java, or Python, as the session involves hands-on coding
- Familiarity with Visual Studio or a similar IDE will help you follow along with the practical aspects
- Basic knowledge of microservices architecture, including service decomposition and inter-service communication
- Basic understanding of cloud services and deployment
