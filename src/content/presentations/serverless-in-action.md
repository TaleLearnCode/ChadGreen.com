...
description: "Hands-on exploration of Azure Functions for building business-critical serverless solutions without managing infrastructure."
type: "session"
durations: [45, 60, 75]
level: "introductory"
tags:
...
resources:
  - type: "github"
    title: "ServerlessInAction Repository"
    url: "https://github.com/TaleLearnCode/ServerlessInAction"
...
- Developers looking to quickly build business-critical functionality without managing infrastructure
- Software engineers interested in exploring serverless architectures on Azure
- Anyone curious about how Azure Functions can accelerate development

### Prerequisites

- Basic familiarity with software development concepts
- Some experience with C# or JavaScript is helpful but not required
