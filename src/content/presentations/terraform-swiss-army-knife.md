...
description: "Explores how developers can use Terraform as a versatile Infrastructure as Code tool for building, updating, and collaborating on scalable application infrastructure."
type: "session"
durations: [45, 60, 75]
level: "intermediate"
...
- Developers and DevOps engineers looking to adopt Infrastructure as Code
- Teams wanting to bridge the gap between development and operations
- Anyone exploring Terraform for cloud infrastructure management

### Prerequisites

- Basic familiarity with cloud concepts and at least one cloud provider (Azure, AWS, or GCP)
- Some experience with command-line tools and scripting
